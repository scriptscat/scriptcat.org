...
Ekstensi ini mendukung tiga jenis skrip:

- Skrip latar depan
- [Skrip latar belakang](./background.md)
- [Skrip terjadwal](./background.md#scheduled-script-crontab)

Skrip latar depan adalah yang biasanya dimaksud orang dengan skrip Tampermonkey. Skrip latar belakang dan skrip terjadwal adalah jenis skrip khusus ekstensi ScriptCat — lihat dokumentasi terkait untuk detailnya.
