...
Bu eklenti üç tür betiği destekler:

- Ön plan betikleri
- [Arka plan betikleri](./background.md)
- [Zamanlanmış betikler](./background.md#scheduled-script-crontab)

Ön plan betikleri, insanların genellikle Tampermonkey betikleri derken kastettiği şeydir. Arka plan betikleri ve zamanlanmış betikler, ScriptCat eklentisine özgü betik türleridir — ayrıntılar için ilgili belgelere bakın.
