...
Per lo sviluppo e il packaging delle Skill, consultare la [Guida allo sviluppo delle Skill](../skill-dev). Esempi ufficiali di Skill: [scriptscat/skills](https://github.com/scriptscat/skills).
