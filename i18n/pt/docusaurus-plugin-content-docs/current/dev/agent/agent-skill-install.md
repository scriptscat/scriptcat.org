...
- [API de gerenciamento de Skills](./agent-skill.md) — gerencie Skills programaticamente a partir de um script
- [Guia de desenvolvimento de Skills](./agent-skill-dev.md) — crie sua própria Skill
